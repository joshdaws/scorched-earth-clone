...
const WORLD_5_LEVELS = [
    ...
    },
    {
        ...
        level: 2,
        name: 'Glitch Garden',
        description: 'Volatile neon fuel cells grow wild in this corrupted digital garden',
        focus: 'Hazard intro: detonate glowing fuel cells to chain explosions into the enemy',
        difficulty: 'very-hard',
        aiDifficulty: AI_DIFFICULTY.HARD,
        enemyHealth: 135,
        playerHealth: 100,
    ...
    },
    {
        ...
        level: 4,
        name: 'Null Island',
        description: 'A collapse node holds this isolated data mass together - barely',
        focus: 'Collapse intro: destroy the support node to drop the terrain under the enemy',
        difficulty: 'very-hard',
        aiDifficulty: AI_DIFFICULTY.HARD_PLUS,
        enemyHealth: 140,
        playerHealth: 100,
    ...
    },
    {
        ...
        level: 6,
        name: 'Void Valley',
        description: 'A rift seeded with fuel cells and a collapse node begging for one good hit',
        focus: 'Remix: start the hazard chain and let it cascade across the valley',
        difficulty: 'very-hard',
        aiDifficulty: AI_DIFFICULTY.HARD_PLUS,
        enemyHealth: 145,
        playerHealth: 100,
    ...
    },
    {
        ...
        level: 8,
        name: 'Overflow Oasis',
        description: 'An overflowing chain of volatile cells winds through impossible terrain',
        focus: 'Remix: trigger the full hazard cascade or pick cells off one by one',
        difficulty: 'very-hard',
        aiDifficulty: AI_DIFFICULTY.HARD_PLUS,
        enemyHealth: 150,
        playerHealth: 100,
